...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/nicbarker/zink' },
    ],
    editLink: {
      pattern: 'https://github.com/nicbarker/zink/edit/main/docs/:path',
      text: 'Edit this page on GitHub',
    },
    footer: {
      message: 'Released under the MIT License.',
      copyright: 'Copyright © 2025-present Zink Contributors',
    },
    search: {
      provider: 'local',
    },
