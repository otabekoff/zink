...
Documentation site for the [Zink](https://github.com/nicbarker/zink) programming language, built with [VitePress](https://vitepress.dev/).
...
MIT — see [LICENSE](https://github.com/nicbarker/zink/blob/main/LICENSE)
