...
[![CI — Lang](https://github.com/nicbarker/zink/actions/workflows/ci-lang.yml/badge.svg)](https://github.com/nicbarker/zink/actions/workflows/ci-lang.yml)
[![CI — IDE](https://github.com/nicbarker/zink/actions/workflows/ci-ide.yml/badge.svg)](https://github.com/nicbarker/zink/actions/workflows/ci-ide.yml)
...
```bash
# Build from source
git clone https://github.com/nicbarker/zink.git
cd zink/lang
cargo build --release
...
MIT © Zink Contributors — see [LICENSE](LICENSE)
